...
// router.get('/shopcart/:func/:id', function(req, res, next) {
//     req.params.func == "delete" -> var shopcart = user.shopcart -> shopcart.remove(id);
//     db.updateUser(user._id, {shopcart: shopcart}, function(){
//         send("success");
//     })
// });
